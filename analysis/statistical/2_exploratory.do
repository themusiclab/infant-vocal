********************************************************************************
********************************************************************************
** IDS analysis: exploratory acoustics *****************************************
** updated for GitHub 06apr2020 ************************************************
********************************************************************************
********************************************************************************

** This script runs exploratory analyses of acoustical features, reported in 
** section 4.1 of Moser et al. (2020)
...
** get data
insheet using ./data/IDS_raw.csv, names

********************************************************************************
** RESTRICT TO EXPLORATORY SAMPLE **********************************************
********************************************************************************
...
log using ./results/IDS_exploratory, replace
...
foreach v of varlist praat_* mir_* tm_* npvi_* {
	...
	** run main regression
	meglm `v' infantdir song ids || id_site: || id_person:, vce(cluster id_site)
...
foreach v of varlist praat_* mir_* tm_* npvi_* {
	...
	sa ./results/temp/`v'_LC1, replace
	clear
...
sa ./results/IDS-exploratory-lincoms, replace
restore
