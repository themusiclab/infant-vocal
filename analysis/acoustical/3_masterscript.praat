...
form Get Acoustic Measurements
	...
	text directory F:\IDSProject\SoundFiles\Malesubclips\
	sentence Sound_file_extension .wav
	comment Full path of the resulting text file. Be sure to include the file name and extension:
	text resultsfile F:\IDSProject\subclips\maleresults.txt
	comment Pitch floor (Change to 100 for females)
	positive minimum_pitch_(Hz) 75
	comment Pitch ceiling (Change to 600 for females)
	...
	# Look for a TextGrid by the same name:
		...
		# Pass through all intervals in the designated tier, and if they have a label, do the analysis at 0.03125 second granularity:
				for itime to numTimes
					...
					resultline$ = "'soundname$'	'curtime$'	'praat_f0$'	'praat_f1$'	'praat_f2$'	'praat_intensity$''newline$'"
